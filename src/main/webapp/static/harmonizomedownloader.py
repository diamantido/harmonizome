...
if __name__ == '__main__':
    ...
    download_datasets([
        ...
        # ('DeepCoverMOA Drug Mechanisms of Action', 'deepcovermoa'),
        ...
        # (DisGeNET Gene-Disease Associations', 'disgenetdisease'),
        # (DisGeNET Gene-Phenotype Associations', 'disgenetphenotype'),
        ...
        # ('KEGG Pathways', 'kegg'),
        # ('Kinase Library Serine Threnonine Kinome Atlas', 'kinaselib'),
        ...
        # ('KnockTF Gene Expression Profiles with Transcription Factor Perturbations', 'knocktf')
        ...
        # ('Sanger Cancer Dependency Map Cancer Cell Line Proteomics', 'sangerdepmap'),
        ...
        # ('Tabula Sapiens Gene-Cell Type Associations', 'tabulasapiens'),
        ...
        # 'processing_scripts.tar.gz',
        # 'kg_serializations.tar.gz'
    ])