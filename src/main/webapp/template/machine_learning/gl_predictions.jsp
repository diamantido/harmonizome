...
<t:wrapper title="${title}" navType="withSearch">
    <div class="machine-learning-page">
    	<h1>GPCR-ligand predictions <span class="note"><c:out value="${note}"/></span></h1>
	    ...
	    <table class="table data-table">
	    	<thead>
	 		...
	 		<c:forEach var="prediction" items="${predictions}">
	 			<tr>
	 				<td>
		 				<a href="${prediction.gpcrGene.endpoint}/${prediction.gpcrGene.urlEncodedValue}">
	                    	<c:out value="${prediction.gpcrGene.symbol}"/>
	                    </a>
	 				</td>
	 				<td>
		 				<a href="${prediction.ligandGene.endpoint}/${prediction.ligandGene.urlEncodedValue}">
