...
import edu.mssm.pharm.maayanlab.Harmonizome.json.serdes.AssociationWithGeneSerializer;
...
public class GeneSetMetadataApi extends HttpServlet {
	...
	static {
		...
		gsonBuilder.registerTypeAdapter(Association.class, new AssociationWithGeneSerializer());
