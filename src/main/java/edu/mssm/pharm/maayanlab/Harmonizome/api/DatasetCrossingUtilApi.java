...
@WebServlet(urlPatterns = {"/" + Constant.DATASET_CROSSING_API_URL + "/util/*"})
public class DatasetCrossingUtilApi extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            List<String> datasets = DatasetCrossingDao.getRightDatasetInPair(dataset1);
