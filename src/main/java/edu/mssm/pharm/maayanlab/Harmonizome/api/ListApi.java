...
public class ListApi {
	...
	public static <T> void doGet(HttpServletRequest request, HttpServletResponse response, Class<T> klass, String endpoint, Gson gson) throws ServletException, IOException {
